...
const code = `import { redirect } from "@i18n";
...
const tabs = [
  { name: 'layout.tsx', isActive: true },
  { name: 'verification.ts', isActive: false },
  { name: 'tailwind.config.ts', isActive: false },
]
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Set up the foundation of your SaaS with staarter.dev, and focus
                on innovating rather than boilerplating.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/docs/setup/getting-started">Get started</Button>
                <Button href="https://staarter.dev/" variant="secondary">
                  Buy a license
                </Button>
              </div>
            </div>
